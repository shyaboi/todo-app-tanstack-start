...
| **8.4d** `Add the motion the design specifies`      | B    | 8.4c       | §4.6's durations, applied where the design asks for them: 120ms on hover and checkbox, 180ms on the panel, 240ms on row removal, and a row that arrives rather than appearing. Nothing animates on load, and `prefers-reduced-motion: reduce` turns all of it off -- already the token contract, now with the transitions to prove it.                                                                                                                                                                                                                                                                                                                                                                                                              |
